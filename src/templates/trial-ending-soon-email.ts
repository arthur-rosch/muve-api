...
export const TrialEndingSoonEmail = ({ name }: TrialEndingSoonProps) => {
  return `<!DOCTYPE html>
...
<p style="margin: 0;"><strong>Seu período trial no muve tá quase terminando...</strong></p>
</div>
</td>
</tr>
</table>
...
<p style="margin: 0;">Seu período de teste gratuito no Muve está chegando ao fim – faltam apenas 2 dias! ⏳</p>
</div>
</td>
</tr>
</table>
...
<td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:25px;">
<div style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:15px;font-weight:400;line-height:150%;text-align:left;mso-line-height-alt:22.5px;">
<p style="margin: 0;">Ainda dá tempo de explorar o que o Muve pode fazer pelos seus vídeos. Aqui estão algumas funcionalidades que você precisa conferir antes que o trial acabe:</p>
<p style="margin: 0;">📊 <strong>Analytics completos em tempo real:</strong> Veja cada detalhe do engajamento do seu público e descubra onde estão as oportunidades de melhoria.</p>
<p style="margin: 0;">🚀 <strong>Smart Autoplay e Botões de Ação personalizados:</strong> Ferramentas poderosas para maximizar a retenção e direcionar a audiência para a conversão.</p>
<p style="margin: 0;">📌 <strong>Capítulos e “Continue Assistindo”:</strong> Facilite a navegação dos seus espectadores e aumente o engajamento nos seus cursos e VSLs.</p>
</div>
</td>
</tr>
</table>
...
<td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:25px;">
<div style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:15px;font-weight:400;line-height:150%;text-align:left;mso-line-height-alt:22.5px;">
<p style="margin: 0;">Lembrando que, com o Muve, você não precisa se preocupar com custos adicionais por visualizações ou banda – é preço fixo para que você possa escalar sem surpresas no fim do mês.</p>
<p style="margin: 0;"> </p>
<p style="margin: 0;"><strong>Pronto para levar suas VSLs e vídeos ao próximo nível?</strong> Não deixe essa oportunidade passar.</p>
</div>
</td>
</tr>
</table>
