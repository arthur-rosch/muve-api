...
export const LateSignatureEmail = ({
  expirationDate,
  name,
  paymentLink,
  value,
...
<p style="margin: 0;"><strong>Sua fatura está atrasada 😬 — Estamos aqui para ajudar!</strong></p>
</div>
</td>
</tr>
</table>
...
<p style="margin: 0;"> </p>
<p style="margin: 0;">Parece que sua última fatura no Muve está um pouco atrasada. Mas sem estresse, sabemos que a correria do dia a dia pode acabar fazendo essas coisas escaparem.</p>
<p style="margin: 0;"> </p>
<p style="margin: 0;">Para que você continue aproveitando todos os recursos incríveis do Muve — vídeos sem logotipos, Analytics detalhados e total personalização — basta regularizar o pagamento o quanto antes.</p>
<p style="margin: 0;"> </p>
<p style="margin: 0;"><strong>Aqui estão os detalhes da sua fatura:</strong></p>
...
<p style="margin: 0;"> </p>
<p style="margin: 0;">Se precisar de qualquer ajuda ou tiver alguma dúvida, estamos aqui! Queremos garantir que você continue aproveitando ao máximo o Muve sem interrupções.</p>
<p style="margin: 0;"> </p>
