...
export const UnsubscribeEmail = ({ name }: UnsubscribeEmailProps) => {
  return `<!DOCTYPE html>
...
<p style="margin: 0;"><strong>Cancelamento Confirmado! Já estamos com saudades... 😢</strong></p>
</div>
</td>
</tr>
</table>
...
<p style="margin: 0;"> </p>
<p style="margin: 0;">Confirmamos que sua assinatura no Muve foi cancelada. Bem, não vamos mentir… já estamos aqui sentindo aquele vazio no coração. Mas sabemos que às vezes uma pausa é necessária.</p>
<p style="margin: 0;"> </p>
<p style="margin: 0;">Se, por acaso, você sentir falta de vídeos sem logotipos, analytics poderosos ou daquela personalização incrível, estaremos aqui, de braços abertos (e sem julgamentos, prometemos!).</p>
<p style="margin: 0;">Qualquer dúvida ou se mudar de ideia, é só nos avisar!</p>
<p style="margin: 0;"> </p>
<p style="margin: 0;">Até logo (ou quem sabe, até breve?),</p>
<p style="margin: 0;">Equipe Muve<br/><em>Seu lugar para vídeos sem limites.</em></p>
</div>
</td>
</tr>
</table>
