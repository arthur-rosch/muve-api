...
exports.OnboardingEmail = void 0;
/* eslint-disable no-irregular-whitespace */
/* eslint-disable no-irregular-whitespace */
const images_1 = require("./images/images");
const OnboardingEmail = ({ name }) => {
    return `<!DOCTYPE html>
...
<div style="max-width: 96px;"><img alt="I'm an image" height="auto" src="${images_1.muveAzul64}" style="display: block; height: auto; border: 0; width: 100%;" title="I'm an image" width="96"/></div>
</div>
</td>
</tr>
</table>
...
<p style="margin: 0;"><strong>Já deu uma olhada em todas as ferramentas que tem disponível para você?</strong></p>
</div>
</td>
</tr>
</table>
...
<td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:25px;">
<div style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:15px;font-weight:400;line-height:150%;text-align:left;mso-line-height-alt:22.5px;">
<p style="margin: 0;">Como está a experiência até agora? 😄 No Muve, nossa missão é facilitar o caminho para suas VSLs e cursos se destacarem e converterem ainda mais. Aqui vão algumas funcionalidades para você testar e começar a ver o impacto:</p>
</div>
</td>
</tr>
</table>
...
<td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:25px;">
<div style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:15px;font-weight:400;line-height:150%;text-align:left;mso-line-height-alt:22.5px;">
<p style="margin: 0;">🔍 <strong>Acompanhe a Retenção em Tempo Real</strong><br/>Veja como seu público está engajado com cada segundo do vídeo. Identifique os pontos fortes e faça ajustes estratégicos.</p>
<p style="margin: 0;">🎬 <strong>Smart Autoplay</strong><br/>O vídeo começa assim que a página carrega, criando uma sensação de urgência. Experimente e veja como o engajamento aumenta!</p>
<p style="margin: 0;">📈 <strong>Botões de Ação e Capítulos</strong><br/>Direcione seu público para a ação com botões customizados e permita que ele navegue pelo conteúdo com capítulos fáceis de acessar.</p>
</div>
</td>
</tr>
</table>
...
<td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:25px;">
<div style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:15px;font-weight:400;line-height:150%;text-align:left;mso-line-height-alt:22.5px;">
<p style="margin: 0;">👉 <strong>Acesse agora e explore seu Dashboard completo:</strong> https://web.muveplayer.com/login</p>
<p style="margin: 0;"> </p>
<p style="margin: 0;"> </p>
<p style="margin: 0;">Nosso objetivo é que você veja resultados desde o início. Fique de olho no seu e-mail — em breve, vamos enviar mais dicas e funcionalidades para você explorar. E lembre-se, estamos aqui para ajudar sempre que precisar.</p>
</div>
</td>
</tr>
</table>
...
<div style="max-width: 96px;"><img alt="Alternate text" height="auto" src="${images_1.logoMuve64}" style="display: block; height: auto; border: 0; width: 100%;" title="Alternate text" width="96"/></div>
</div>
</td>
</tr>
</table>
...
<tr>
<td style="padding:0 10px 0 10px;"><a href="https://www.facebook.com/people/Muve/61566478731090/" target="_blank"><img alt="Facebook" height="auto" src="${images_1.FbIcon}" style="display: block; height: auto; border: 0;" title="Facebook" width="32"/></a></td>
<td style="padding:0 10px 0 10px;"><a href="https://www.instagram.com/muveplayer/" target="_blank"><img alt="Instagram" height="auto" src="${images_1.IgIcon}" style="display: block; height: auto; border: 0;" title="Instagram" width="32"/></a></td>
</tr>
</table>
</div>
</td>
...
<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word; color: #ffffff;">Muve Copyright © 2024</span></p>
</div>
</td>
</tr>
</table>
...
exports.OnboardingEmail = OnboardingEmail;
