...
var add_favorite_folder_exports = {};
__export(add_favorite_folder_exports, {
  addFavoriteFolder: () => addFavoriteFolder
});
module.exports = __toCommonJS(add_favorite_folder_exports);
...
function addFavoriteFolder(request, reply) {
  return __async(this, null, function* () {
    var _a;
    const addFavoriteFolderBodySchema = import_zod2.z.object({
      folderId: import_zod2.z.string(),
