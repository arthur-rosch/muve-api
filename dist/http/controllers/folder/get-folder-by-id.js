...
var get_folder_by_id_exports = {};
__export(get_folder_by_id_exports, {
  getFolderById: () => getFolderById
});
module.exports = __toCommonJS(get_folder_by_id_exports);
...
function getFolderById(request, reply) {
  return __async(this, null, function* () {
    var _a;
    const getFolderByIdBodySchema = import_zod2.z.object({
