...
var delete_folder_exports = {};
__export(delete_folder_exports, {
  deleteFolder: () => deleteFolder
});
module.exports = __toCommonJS(delete_folder_exports);
...
function deleteFolder(request, reply) {
  return __async(this, null, function* () {
    var _a;
    const deleteFolderBodySchema = import_zod2.z.object({
