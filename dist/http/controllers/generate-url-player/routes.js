...
__export(routes_exports, {
  generateUrlPlayerRoutes: () => generateUrlPlayerRoutes
});
...
var GenerateSignedUrlUseCase = class {
  ...
  execute(videoPlayerId) {
    return __async(this, null, function* () {
      ...
      const token = (0, import_jsonwebtoken.sign)(payload, secretKey2);
...
function generateSignedUrl(request, reply) {
  return __async(this, null, function* () {
    const generateSignedUrlBodySchema = import_zod2.z.object({
      videoPlayerId: import_zod2.z.string()
    });
...
var ValidateSignedUrlUseCase = class {
  ...
  execute(videoPlayerId, token) {
    return __async(this, null, function* () {
      ...
      try {
        const secretKey2 = env.JWT_SECRET;
        const decoded = (0, import_jsonwebtoken2.verify)(token, secretKey2);
        return decoded.videoPlayerId === videoPlayerId && decoded.exp > Math.floor(Date.now() / 1e3);
      } catch (error) {
        if (error instanceof import_jsonwebtoken2.JsonWebTokenError) {
          return false;
        }
        throw error;
      }
...
function invalidateToken(request, reply) {
  return __async(this, null, function* () {
    const invalidateTokenBodySchema = import_zod3.z.object({
...
// src/http/controllers/generate-url-player/routes.ts
function generateUrlPlayerRoutes(app) {
  return __async(this, null, function* () {
