...
// src/http/controllers/video/get-config-video-by-player-id.ts
var get_config_video_by_player_id_exports = {};
__export(get_config_video_by_player_id_exports, {
  getConfigVideoByPlayerId: () => getConfigVideoByPlayerId
});
...
function getConfigVideoByPlayerId(request, reply) {
  return __async(this, null, function* () {
    const getConfigVideoByPlayerIdParamsSchema = import_zod2.z.object({
