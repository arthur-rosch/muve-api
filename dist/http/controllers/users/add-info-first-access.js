...
var add_info_first_access_exports = {};
__export(add_info_first_access_exports, {
  AddInfoFirstAccess: () => AddInfoFirstAccess
});
module.exports = __toCommonJS(add_info_first_access_exports);
...
function AddInfoFirstAccess(request, reply) {
  return __async(this, null, function* () {
    var _a;
    const addInfoFirstAccessBodySchema = import_zod2.z.object({
      accountType: import_zod2.z.string(),
      memberArea: import_zod2.z.string(),
      videoHosting: import_zod2.z.string()
    });
