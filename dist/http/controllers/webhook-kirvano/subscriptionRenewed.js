...
var subscriptionRenewed_exports = {};
__export(subscriptionRenewed_exports, {
  subscriptionRenewed: () => subscriptionRenewed
});
module.exports = __toCommonJS(subscriptionRenewed_exports);
...
function subscriptionRenewed(request, reply) {
  return __async(this, null, function* () {
    const subscriptionRenewedEventSchema = import_zod2.z.object({
