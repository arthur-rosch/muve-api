...
var subscriptionCanceled_exports = {};
__export(subscriptionCanceled_exports, {
  subscriptionCanceled: () => subscriptionCanceled
});
module.exports = __toCommonJS(subscriptionCanceled_exports);
...
function subscriptionCanceled(request, reply) {
  return __async(this, null, function* () {
    const subscriptionCanceledEventSchema = import_zod2.z.object({
