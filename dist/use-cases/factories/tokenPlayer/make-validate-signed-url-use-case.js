...
var make_validate_signed_url_use_case_exports = {};
__export(make_validate_signed_url_use_case_exports, {
  makeValidateSignedUrlUseCase: () => makeValidateSignedUrlUseCase
});
module.exports = __toCommonJS(make_validate_signed_url_use_case_exports);
  ...
  execute(videoPlayerId, token) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        const decoded = (0, import_jsonwebtoken.verify)(token, secretKey);
