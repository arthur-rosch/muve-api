...
var make_generate_signed_url_use_case_exports = {};
__export(make_generate_signed_url_use_case_exports, {
  makeGenerateSignedUrlUseCase: () => makeGenerateSignedUrlUseCase
});
module.exports = __toCommonJS(make_generate_signed_url_use_case_exports);
...
var GenerateSignedUrlUseCase = class {
  ...
  execute(videoPlayerId) {
    return __async(this, null, function* () {
      ...
      const token = (0, import_jsonwebtoken.sign)(payload, secretKey);
