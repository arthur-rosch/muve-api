...
var make_get_analytics_by_video_id_use_case_exports = {};
__export(make_get_analytics_by_video_id_use_case_exports, {
  makeGetAnalyticsByVideoIdUseCase: () => makeGetAnalyticsByVideoIdUseCase
});
module.exports = __toCommonJS(make_get_analytics_by_video_id_use_case_exports);
...
0 && (module.exports = {
  makeGetAnalyticsByVideoIdUseCase
});
