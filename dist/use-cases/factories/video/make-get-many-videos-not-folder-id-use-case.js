...
var make_get_many_videos_not_folder_id_use_case_exports = {};
__export(make_get_many_videos_not_folder_id_use_case_exports, {
  makeGetManyVideoNotFolderIdUseCase: () => makeGetManyVideoNotFolderIdUseCase
});
module.exports = __toCommonJS(make_get_many_videos_not_folder_id_use_case_exports);
...
0 && (module.exports = {
  makeGetManyVideoNotFolderIdUseCase
});
