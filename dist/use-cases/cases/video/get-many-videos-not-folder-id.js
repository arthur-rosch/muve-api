...
var get_many_videos_not_folder_id_exports = {};
__export(get_many_videos_not_folder_id_exports, {
  GetManyVideoNotFolderIdUseCase: () => GetManyVideoNotFolderIdUseCase
});
module.exports = __toCommonJS(get_many_videos_not_folder_id_exports);
...
0 && (module.exports = {
  GetManyVideoNotFolderIdUseCase
});
