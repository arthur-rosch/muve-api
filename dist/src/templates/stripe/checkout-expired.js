...
exports.CheckoutExpired = void 0;
/* eslint-disable no-irregular-whitespace */
const images_1 = require("../images/images");
const CheckoutExpired = ({ name, url }) => {
    return `<!DOCTYPE html>
...
<p style="margin: 0;"><strong>Você está apenas a um passo de ter acesso a melhor ferramenta de vídeo do mercado...</strong></p>
</div>
</td>
</tr>
</table>
...
<p style="margin: 0;"> </p>
<p style="margin: 0;">Notamos que você começou seu cadastro no Muve, mas ainda falta só um passo para liberar o seu teste gratuito.</p>
<p style="margin: 0;"> </p>
<p style="margin: 0;">Com o Muve, você tem acesso a ferramentas poderosas para otimizar seus vídeos de vendas e cursos, como análises detalhadas de retenção e personalização total do player. E o melhor: você pode testar tudo isso sem custo por 7 dias!</p>
<p style="margin: 0;"> </p>
<p style="margin: 0;">👉 <strong>Complete seu cadastro e descubra o que o Muve pode fazer pelo seu negócio!</strong></p>
</div>
</td>
</tr>
</table>
...
<div style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:15px;font-weight:400;line-height:150%;text-align:left;mso-line-height-alt:22.5px;">
<p style="margin: 0;">Qualquer dúvida, estamos por aqui para ajudar! 😊</p>
<p style="margin: 0;">Não perde tempo</p>
</div>
</td>
</tr>
</table>
