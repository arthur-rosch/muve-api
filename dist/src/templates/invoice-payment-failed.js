...
exports.InvoicePaymentFailedEmail = void 0;
/* eslint-disable no-irregular-whitespace */
const images_1 = require("./images/images");
const InvoicePaymentFailedEmail = ({ name, plan, price, }) => {
    return `<!DOCTYPE html>
...
<div style="max-width: 144px;"><img alt="I'm an image" height="auto" src="${images_1.muveAzul64}" style="display: block; height: auto; border: 0; width: 100%;" title="I'm an image" width="144"/></div>
</div>
</td>
</tr>
</table>
...
<p style="margin: 0;">Notamos que houve uma falha no processamento do pagamento da sua assinatura do Muve. Pode ter sido um problema temporário com o cartão ou outra questão técnica.</p>
<p style="margin: 0;"> </p>
...
<p style="margin: 0;"> </p>
<p style="margin: 0;">Para garantir que você desfrute de todas as funcionalidades do Muve sem interrupções, recomendamos que verifique seus dados de pagamento ou tente realizar o pagamento novamente.</p>
<p style="margin: 0;"> </p>
<p style="margin: 0;">Se precisar de ajuda ou tiver dúvidas, nossa equipe de suporte está pronta para te ajudar.</p>
</div>
</td>
</tr>
</table>
...
<td style="padding:0 10px 0 10px;"><a href="https://www.instagram.com/muveplayer/" target="_blank"><img alt="Instagram" height="auto" src="i${images_1.IgIcon}" style="display: block; height: auto; border: 0;" title="Instagram" width="32"/></a></td>
</tr>
</table>
</div>
</td>
...
exports.InvoicePaymentFailedEmail = InvoicePaymentFailedEmail;
