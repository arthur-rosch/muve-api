...
class PrimasViewUniqueRepository {
    findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const view = yield prisma_1.prisma.viewUnique.findUnique({
                where: {
                    id,
                },
            });
    ...
    findManyByVideoAnalyticsId(videoAnalyticsId) {
        return __awaiter(this, void 0, void 0, function* () {
            const views = yield prisma_1.prisma.viewUnique.findMany({
                where: {
                    videoAnalyticsId,
                },
            });
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const view = yield prisma_1.prisma.viewUnique.create({
                data,
            });
            return view;
        });
