...
var prisma_chapter_repository_exports = {};
__export(prisma_chapter_repository_exports, {
  PrismaChaptersRepository: () => PrismaChaptersRepository
});
module.exports = __toCommonJS(prisma_chapter_repository_exports);
  ...
  deleteManyByVideoId(videoId) {
    return __async(this, null, function* () {
      const result = yield prisma.$transaction((prisma2) => __async(this, null, function* () {
        const chapter = yield prisma2.chapter.deleteMany({
          where: {
            videoId
          }
        });
