...
var prisma_video_buttons_repository_exports = {};
__export(prisma_video_buttons_repository_exports, {
  PrismaVideoButtonsRepository: () => PrismaVideoButtonsRepository
});
module.exports = __toCommonJS(prisma_video_buttons_repository_exports);
...
var PrismaVideoButtonsRepository = class {
  ...
  deleteManyByVideoId(videoId) {
    return __async(this, null, function* () {
      const result = yield prisma.$transaction((prisma2) => __async(this, null, function* () {
        const videoButtons = yield prisma2.videoButtons.deleteMany({
          where: {
            videoId
          }
        });
